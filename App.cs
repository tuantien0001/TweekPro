...
namespace TweekPro {
 public partial class MainForm:Form {
  ...
  public MainForm(bool preview=false){
   ...
   BuildDuplicateTab();
   BuildNetworkTab();
   var ordered=new TabPage[]{installed,clean,junkTab,dupeTab,vault,autorunTab,netTab,toolsTab,logs};
