...
| **Ứng dụng** | Ứng dụng desktop (HKLM/HKCU), gỡ theo hàng đợi, quét phần còn sót sau khi gỡ, cột **Cảnh báo** PUP/bloatware với lý do bằng lời thường, lọc «Chỉ hiện mục cảnh báo», CSV, chuột phải. **Dung lượng** lấy từ bộ cài; thiếu thì đọc sổ Steam (`libraryfolders.vdf`, kể cả thư viện ở ổ khác) hoặc đo thư mục cài / thư mục trình gỡ | Không dùng Win32_Product; chặn lệnh gỡ qua cmd/PowerShell; nhà phát hành cốt lõi (Microsoft, Google, Mozilla, NVIDIA, Intel, AMD…) không bao giờ bị đánh dấu; không đo Program Files, Windows hay gốc ổ đĩa |
