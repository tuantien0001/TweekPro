...
namespace TweekPro.Core {
 ...
 public static class L {
  ...
  static readonly Dictionary<string,string> table=Merge(LangEn.Table,Pup.PupLang.Table,Stale.StaleLang.Table,Update.UpdateLang.Table,Startup.StartupLang.Table);
