 ...
 public static class LangTests {
  ...
  public static void Run(){
   ...
   try{
    ...
    foreach(string tab in new[]{"Tổng quan","Ứng dụng","Phần còn sót","Dọn rác","Thư mục rỗng","Tệp trùng lặp","Phân tích ổ đĩa","Kho khôi phục","Khởi động","Mạng","Công cụ","Nhật ký"})
