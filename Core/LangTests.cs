 ...
 public static class LangTests {
  ...
  public static void Run(){
   ...
   try{
    ...
    foreach(string tab in new[]{"Tổng quan","Ứng dụng","Ứng dụng Windows","Phần còn sót","Dọn rác","Thư mục rỗng","Tệp trùng lặp","Tệp tải về cũ","Dấu vết","Registry","Phân tích ổ đĩa","Kho khôi phục","Khởi động","Explorer","Mạng","Công cụ","Nhật ký"})
