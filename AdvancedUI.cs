...
namespace TweekPro {
 public partial class MainForm {
  ...
  public void PreviewAdvanced(string mode){if(mode=="autorun"){ShowAutoruns(Advanced.Autoruns());tabs.SelectedTab=autorunTab;}else if(mode=="junk")tabs.SelectedTab=junkTab;else if(mode=="network")tabs.SelectedTab=netTab;else if(mode=="health")PreviewHealth();else tabs.SelectedTab=toolsTab;}
 }
}
