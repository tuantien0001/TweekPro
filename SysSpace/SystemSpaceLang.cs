...
namespace TweekPro.SysSpace {
 ...
 public static class SystemSpaceLang {
  public static readonly Dictionary<string,string> Table=new Dictionary<string,string>(StringComparer.Ordinal){
   ...
   {"Chưa đo.","Not measured."},{"Chỉ hiển thị","Display only"},{"Không có / không áp dụng","Absent / not applicable"},{"Có thể tắt (đảo ngược được)","Can be turned off (reversible)"},{"Có thể dọn bằng công cụ Windows","Cleanable with a Windows tool"},
