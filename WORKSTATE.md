...
Updated: 2026-09-22 12:20 (Asia/Bangkok).
Status: DONE (Cursor), not released. Owner (11:32): "làm 3 cái này" — extensions removable + Forcelist, Tracks ~10 sources + cookie whitelist + clean on exit, System Space background + estimates + Installer orphans.
Last editor: Cursor.

## Current task (12:20)

O. DONE Three upgrades, version string stays 0.7.5, README `### 0.7.6 (chưa phát hành)` written.
